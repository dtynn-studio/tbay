...
impl Default for Hub {
    fn default() -> Self {
        ...
        hub.register_indicator_builder(indicator::rsi::RsiBuilder);
        hub.register_indicator_builder(indicator::shadow::ShadowBuilder);
        ...
        hub.register_monitor_builder(monitor::ma_seq::MaSeqBuilder);
